...
<body>
<%
    String r = (String)request.getAttribute("r");         // 获取错误属性
    if(r != null) {
%>
<script type="text/javascript" language="javascript">
    alert("<%=r%>");                                            // 弹出错误信息
    window.location='housecomponent.jsp' ;                            // 跳转到登录界面
</script>
<%
    }
%>
...
<div class="table_">
    <!--列表填充-->
    <%
        out.println(control.findhousecomponent());
    %>
</div>
