...
<body>
<%
    String s = (String)request.getAttribute("s");         // 获取错误属性
    if(s != null) {
%>
<script type="text/javascript" language="javascript">
    alert("<%=s%>");                                            // 弹出错误信息
    window.location='housecomputer.jsp' ;                            // 跳转到登录界面
</script>
<%
    }
%>
...
<%--    菜单栏--%>
<div class="blank">
    <a href ="bianji_computer.jsp">编辑</a>
...
<div class="row">
    <ul class="a1" id="test_2">
        ...
        <li><a href="#" class="active">电脑信息查询</a></li>
        <li><a href="housecomponent.jsp">零件查询</a></li>
        <li><a href="houseblueprint.jsp">图纸匹配查询 </a></li>
        <li><a href="#">管理员：<%=controller_name%></a></li>
    </ul>
</div>
...
<div class="table_">
    <!--列表填充-->
    <%
        out.println(control.findhouse_computer());
    %>
</div>
